...
// alg_pot2.h
//
// Header file for the AlgPot2 class.
//
// AlgPot2 is derived from Alg and it measures the potential
// into different propagation directions
//
//------------------------------------------------------------------


#ifndef INCLUDED_ALG_POT2_H
#define INCLUDED_ALG_POT2_H
...
class AlgPot2 : public Alg
{
 ...
 public:
    AlgPot2(Lattice & latt, CommonArg *c_arg, PotArg *arg);
