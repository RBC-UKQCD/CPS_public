...
namespace bfm_evo_aux {
    ...
    {
        p[0] = p[8] = p[16] = 0.; //real diagonal elements
    ...
    template<class Float>
    static inline void mStarDotMTransEqual(Float* c, const Float* a, const Float* b){
	c[0] =  a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3] + a[4] * b[4] + a[5] * b[5];
	c[1] =  a[0] * b[1] - a[1] * b[0] + a[2] * b[3] - a[3] * b[2] + a[4] * b[5] - a[5] * b[4];
	c[2] =  a[0] * b[6] + a[1] * b[7] + a[2] * b[8] + a[3] * b[9] + a[4] * b[10] + a[5] * b[11];
	c[3] =  a[0] * b[7] - a[1] * b[6] + a[2] * b[9] - a[3] * b[8] + a[4] * b[11] - a[5] * b[10];
	c[4] =  a[0] * b[12] + a[1] * b[13] + a[2] * b[14] + a[3] * b[15] + a[4] * b[16] + a[5] * b[17];
	c[5] =  a[0] * b[13] - a[1] * b[12] + a[2] * b[15] - a[3] * b[14] + a[4] * b[17] - a[5] * b[16];
	c[6] =  a[6] * b[0] + a[7] * b[1] + a[8] * b[2] + a[9] * b[3] + a[10] * b[4] + a[11] * b[5];
	c[7] =  a[6] * b[1] - a[7] * b[0] + a[8] * b[3] - a[9] * b[2] + a[10] * b[5] - a[11] * b[4];
	c[8] =  a[6] * b[6] + a[7] * b[7] + a[8] * b[8] + a[9] * b[9] + a[10] * b[10] + a[11] * b[11];
	c[9] =  a[6] * b[7] - a[7] * b[6] + a[8] * b[9] - a[9] * b[8] + a[10] * b[11] - a[11] * b[10];
	c[10] =  a[6] * b[12] + a[7] * b[13] + a[8] * b[14] + a[9] * b[15] + a[10] * b[16] + a[11] * b[17];
	c[11] =  a[6] * b[13] - a[7] * b[12] + a[8] * b[15] - a[9] * b[14] + a[10] * b[17] - a[11] * b[16];
	c[12] =  a[12] * b[0] + a[13] * b[1] + a[14] * b[2] + a[15] * b[3] + a[16] * b[4] + a[17] * b[5];
	c[13] =  a[12] * b[1] - a[13] * b[0] + a[14] * b[3] - a[15] * b[2] + a[16] * b[5] - a[17] * b[4];
	c[14] =  a[12] * b[6] + a[13] * b[7] + a[14] * b[8] + a[15] * b[9] + a[16] * b[10] + a[17] * b[11];
	c[15] =  a[12] * b[7] - a[13] * b[6] + a[14] * b[9] - a[15] * b[8] + a[16] * b[11] - a[17] * b[10];
	c[16] =  a[12] * b[12] + a[13] * b[13] + a[14] * b[14] + a[15] * b[15] + a[16] * b[16] + a[17] * b[17];
	c[17] =  a[12] * b[13] - a[13] * b[12] + a[14] * b[15] - a[15] * b[14] + a[16] * b[17] - a[17] * b[16];
    }
