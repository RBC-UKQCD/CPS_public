...
void setup(int *argc, char*** argv){
  ...
  if(quo_tm_arg.bi_arg.fermion == F_CLASS_BFM_TYPE2) init_bfm_wilsontm();
  else if(quo_tm_arg.bi_arg.fermion != F_CLASS_WILSON_TM) ERR.General(cname,fname,"quo_tm_arg fermion type can only be either F_CLASS_WILSON_TM or F_CLASS_BFM_TYPE2");
}
