...
//
//  $Author: mcneile $
//  $Date: 2003-07-29 10:14:52 $
//  $Header: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/tests/xi_spect_gsum/main.C,v 1.2 2003-07-29 10:14:52 mcneile Exp $
//  $Id: main.C,v 1.2 2003-07-29 10:14:52 mcneile Exp $
...
//                          Vector
//
//  Revision 1.9  2001/09/06 11:51:45  anj
...
//
//  Revision 1.6  2001/08/16 10:50:13  anj
...
//
//  Revision 1.4  2001/06/28 14:34:20  anj
//
...
int main(int argc,char *argv[])
{
  ...
  // parameters relevant to anisotropy and clover.
  do_arg.clover_coeff = 2.181070;
  do_arg.clover_coeff_xi = 1.349636; 
  do_arg.xi_bare = 1.65472887; 
  do_arg.xi_dir  = 3;    
  do_arg.xi_v    = 1.01;
  do_arg.xi_v_xi = 1.11;
  
  // parameters relevant to global sum
  do_arg.gsum_fast_mode = 0;
  do_arg.gsum_max_try = 2;
  ...
  //----------------------------------------------------------------
  // Initialize arguments for the new Wilson spectrum code.
  //----------------------------------------------------------------
