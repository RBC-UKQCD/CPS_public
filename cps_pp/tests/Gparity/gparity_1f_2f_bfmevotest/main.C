...
static void mTransDotMStarEqual(Float* C, const Float* A, const Float* B){
  C[0] =  (B[0] * A[0] + B[1] * A[1]) + (B[6] * A[6] + B[7] * A[7]) + (B[12] * A[12] + B[13] * A[13]);
  C[1] =  (B[0] * A[1] - B[1] * A[0]) + (B[6] * A[7] - B[7] * A[6]) + (B[12] * A[13] - B[13] * A[12]);
  C[2] =  (B[0] * A[2] + B[1] * A[3]) + (B[6] * A[8] + B[7] * A[9]) + (B[12] * A[14] + B[13] * A[15]);
  C[3] =  (B[0] * A[3] - B[1] * A[2]) + (B[6] * A[9] - B[7] * A[8]) + (B[12] * A[15] - B[13] * A[14]);
  C[4] =  (B[0] * A[4] + B[1] * A[5]) + (B[6] * A[10] + B[7] * A[11]) + (B[12] * A[16] + B[13] * A[17]);
  C[5] =  (B[0] * A[5] - B[1] * A[4]) + (B[6] * A[11] - B[7] * A[10]) + (B[12] * A[17] - B[13] * A[16]);
  C[6] =  (B[2] * A[0] + B[3] * A[1]) + (B[8] * A[6] + B[9] * A[7]) + (B[14] * A[12] + B[15] * A[13]);
  C[7] =  (B[2] * A[1] - B[3] * A[0]) + (B[8] * A[7] - B[9] * A[6]) + (B[14] * A[13] - B[15] * A[12]);
  C[8] =  (B[2] * A[2] + B[3] * A[3]) + (B[8] * A[8] + B[9] * A[9]) + (B[14] * A[14] + B[15] * A[15]);
  C[9] =  (B[2] * A[3] - B[3] * A[2]) + (B[8] * A[9] - B[9] * A[8]) + (B[14] * A[15] - B[15] * A[14]);
  C[10] =  (B[2] * A[4] + B[3] * A[5]) + (B[8] * A[10] + B[9] * A[11]) + (B[14] * A[16] + B[15] * A[17]);
  C[11] =  (B[2] * A[5] - B[3] * A[4]) + (B[8] * A[11] - B[9] * A[10]) + (B[14] * A[17] - B[15] * A[16]);
  C[12] =  (B[4] * A[0] + B[5] * A[1]) + (B[10] * A[6] + B[11] * A[7]) + (B[16] * A[12] + B[17] * A[13]);
  C[13] =  (B[4] * A[1] - B[5] * A[0]) + (B[10] * A[7] - B[11] * A[6]) + (B[16] * A[13] - B[17] * A[12]);
  C[14] =  (B[4] * A[2] + B[5] * A[3]) + (B[10] * A[8] + B[11] * A[9]) + (B[16] * A[14] + B[17] * A[15]);
  C[15] =  (B[4] * A[3] - B[5] * A[2]) + (B[10] * A[9] - B[11] * A[8]) + (B[16] * A[15] - B[17] * A[14]);
  C[16] =  (B[4] * A[4] + B[5] * A[5]) + (B[10] * A[10] + B[11] * A[11]) + (B[16] * A[16] + B[17] * A[17]);
  C[17] =  (B[4] * A[5] - B[5] * A[4]) + (B[10] * A[11] - B[11] * A[10]) + (B[16] * A[17] - B[17] * A[16]);
}

static int no_gparity_test(GwilsonFdwf* lattice, const BfmSolver &solver){
...
int main(int argc,char *argv[])
{
  ...
  if(!gparity_X && !gparity_Y) return no_gparity_test(lattice, solver);
