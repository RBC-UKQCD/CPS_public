...
//  $Header: /space/cvs/cps/cps++/src/alg/alg_w_spect/w_baryon.C,v 1.9 2004/08/18 11:57:40 zs Exp $
//  $Id: w_baryon.C,v 1.9 2004/08/18 11:57:40 zs Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: w_baryon.C,v $
//  $Revision: 1.9 $
//  $Source: /space/cvs/cps/cps++/src/alg/alg_w_spect/w_baryon.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
...
// static data members
//---------------------------------------------------------------------------
const char * WspectBaryon::d_class_name = "WspectBaryon";
