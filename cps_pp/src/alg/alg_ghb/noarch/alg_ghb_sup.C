...
//  $Header: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/alg/alg_ghb/noarch/alg_ghb_sup.C,v 1.2 2004-01-13 20:38:58 chulwoo Exp $
//  $Id: alg_ghb_sup.C,v 1.2 2004-01-13 20:38:58 chulwoo Exp $
...
#define	R	0
#define	I	1
  UniformRandomGenerator URG(-1,1);
  ...
  aA[0][R] = 1-squeeze*(1.+URG.Rand());
  aA[0][I] = squeeze*URG.Rand();
  aA[1][R] = squeeze*URG.Rand();
  aA[1][I] = squeeze*URG.Rand();
  aA[2][R] = squeeze*URG.Rand();
  aA[2][I] = squeeze*URG.Rand();
  ...
  Bprime[0][R] = squeeze*URG.Rand();
  Bprime[0][I] = squeeze*URG.Rand();
  Bprime[1][R] = 1-squeeze*(1.+URG.Rand());
  Bprime[1][I] = squeeze*URG.Rand();
  Bprime[2][R] = squeeze*URG.Rand();
  Bprime[2][I] = squeeze*URG.Rand();
