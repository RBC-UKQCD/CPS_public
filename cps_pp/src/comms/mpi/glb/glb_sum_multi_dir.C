...
//  $Header: /space/cvs/cps/cps++/src/comms/mpi/glb/glb_sum_multi_dir.C,v 1.4 2008/02/08 18:35:06 chulwoo Exp $
//  $Id: glb_sum_multi_dir.C,v 1.4 2008/02/08 18:35:06 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: glb_sum_multi_dir.C,v $
//  $Revision: 1.4 $
//  $Source: /space/cvs/cps/cps++/src/comms/mpi/glb/glb_sum_multi_dir.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
//--------------------------------------------------------------
