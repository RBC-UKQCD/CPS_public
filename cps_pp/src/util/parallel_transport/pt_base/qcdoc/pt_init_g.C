...
//  $Header: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qcdoc/pt_init_g.C,v 1.2 2006/07/13 20:14:44 chulwoo Exp $
//  $Id: pt_init_g.C,v 1.2 2006/07/13 20:14:44 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: pt_init_g.C,v $
//  $Revision: 1.2 $
//  $Source: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qcdoc/pt_init_g.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
