...
//  $Header: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qcdoc/pt_shift.C,v 1.1 2006/07/05 18:13:49 chulwoo Exp $
//  $Id: pt_shift.C,v 1.1 2006/07/05 18:13:49 chulwoo Exp $
//  $Name: v5_0_16_hantao_io_test_v7 $
//  $Locker:  $
//  $RCSfile: pt_shift.C,v $
//  $Revision: 1.1 $
//  $Source: /space/cvs/cps/cps++/src/util/parallel_transport/pt_base/qcdoc/pt_shift.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
