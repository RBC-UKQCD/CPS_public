...
extern "C" {
#endif
 void copy_matrix_s (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3,unsigned long Arg4)
{
  ...
  if ( counter <= 0 ) goto copy_matrix_s_lab0;
  LOOKUP0 = Uptr | Uptr ; 
PRER0=PRE0;
PRER1=PRE1;
PRER2=PRE2;
...
copy_matrix_s_lab1:
  ...
  if ( predicate >= 0 ) goto copy_matrix_s_lab2;
...
/*preload PRER1 U_idx */
  ...
  *( (Float *) ( (UIMM221) + (Vptr) ) ) = U221; 
  ...
  if ( counter >  0 ) goto copy_matrix_s_lab1;
copy_matrix_s_lab0:
