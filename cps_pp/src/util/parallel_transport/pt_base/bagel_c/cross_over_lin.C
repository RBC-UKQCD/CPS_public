...
extern "C" {
#endif
 void cross_over_lin (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3,unsigned long Arg4,unsigned long Arg5,unsigned long Arg6)
{
...
PRER4=PRE4;
  ...
  if ( counter <= 0 ) goto cross_over_lin_lab0;
...
/*pragma_dcbt_space 5*/
  ...
  *( (Float *) ( (MAT_IMM011) + (outptr) ) ) = mat011; 
  ...
  if ( predicate >= 0 ) goto cross_over_lin_lab2;
...
/*preload PRER2 vec2ptr */
  ...
  *( (Float *) ( (MAT_IMM101) + (outptr) ) ) = mat101; 
  ...
  if ( predicate >= 0 ) goto cross_over_lin_lab3;
  prefscratch = StackPointer | StackPointer ; 
cross_over_lin_lab3:
/*preload PRER0 prefscratch */
/*preload PRER1 prefscratch */
...
/*preload PRER1 dest_idx */
  ...
  *( (Float *) ( (MAT_IMM221) + (outptr) ) ) = mat221; 
  ...
  if ( counter >  0 ) goto cross_over_lin_lab1;
cross_over_lin_lab0:
