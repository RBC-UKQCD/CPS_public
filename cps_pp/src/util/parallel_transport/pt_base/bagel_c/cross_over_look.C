...
extern "C" {
#endif
 void cross_over_look (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3,unsigned long Arg4,unsigned long Arg5,unsigned long Arg6)
{
...
PRER4=PRE4;
  ...
  if ( counter <= 0 ) goto cross_over_look_lab0;
...
/*pragma_dcbt_space 5*/
  ...
  *( (Float *) ( (MAT_IMM011) + (outptr) ) ) = mat011; 
  ...
  if ( predicate >= 0 ) goto cross_over_look_lab2;
...
/*preload PRER1 src1_idx */
  ...
  *( (Float *) ( (MAT_IMM021) + (outptr) ) ) = mat021; 
  ...
  if ( predicate >= 0 ) goto cross_over_look_lab3;
  prefscratch = StackPointer | StackPointer ; 
...
/*preload PRER1 src2_idx */
  ...
  *( (Float *) ( (MAT_IMM101) + (outptr) ) ) = mat101; 
  ...
  if ( predicate >= 0 ) goto cross_over_look_lab4;
  prefscratch = StackPointer | StackPointer ; 
...
/*preload PRER1 dest_idx */
  ...
  *( (Float *) ( (MAT_IMM221) + (outptr) ) ) = mat221; 
  ...
  if ( counter >  0 ) goto cross_over_look_lab1;
