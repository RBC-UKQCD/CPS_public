...
extern "C" {
#endif
 void cross_lin_s (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3,unsigned long Arg4,unsigned long Arg5,unsigned long Arg6)
{
...
PRER2=PRE2;
  ...
  if ( counter <= 0 ) goto cross_lin_s_lab0;
...
/*pragma_dcbt_space 5*/
  ...
  *( (Float *) ( (MAT_IMM011) + (outptr) ) ) = mat011; 
  ...
  if ( predicate >= 0 ) goto cross_lin_s_lab2;
...
/*preload PRER0 vec2ptr */
  ...
  *( (Float *) ( (MAT_IMM101) + (outptr) ) ) = mat101; 
  ...
  if ( predicate >= 0 ) goto cross_lin_s_lab3;
  prefscratch = StackPointer | StackPointer ; 
cross_lin_s_lab3:
/*preload PRER0 prefscratch */
...
/*preload PRER1 dest_idx */
  ...
  *( (Float *) ( (MAT_IMM221) + (outptr) ) ) = mat221; 
  ...
  if ( counter >  0 ) goto cross_lin_s_lab1;
cross_lin_s_lab0:
