...
extern "C" {
#endif
 void cross_look_s (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3,unsigned long Arg4,unsigned long Arg5,unsigned long Arg6)
{
...
PRER1=PRE1;
  ...
  LOOKUP1 = vec2ptr | vec2ptr ; 
  prefscratch = * ( (unsigned long *) ( (PRE0)+(src2_idx) ) )  ;
  prefscratch = prefscratch * VEC_ATOM ; 
  vec2ptr = LOOKUP1 + prefscratch ; 
  LOOKUP2 = matptr | matptr ; 
PRER2=PRE2;
  prefscratch = * ( (unsigned long *) ( (PRE0)+(dest_idx) ) )  ;
  prefscratch = prefscratch * MAT_ATOM ; 
  matptr = LOOKUP2 + prefscratch ; 
  if ( counter <= 0 ) goto cross_look_s_lab0;
  ...
  mat000 = *( (Float *) ( (MAT_IMM000) + (matptr) ) ) ; 
  mat001 = *( (Float *) ( (MAT_IMM001) + (matptr) ) ) ; 
  mat010 = *( (Float *) ( (MAT_IMM010) + (matptr) ) ) ; 
  mat011 = *( (Float *) ( (MAT_IMM011) + (matptr) ) ) ; 
  mat020 = *( (Float *) ( (MAT_IMM020) + (matptr) ) ) ; 
  mat021 = *( (Float *) ( (MAT_IMM021) + (matptr) ) ) ; 
cross_look_s_lab1:
/*pragma_dcbt_space 5*/
  outptr = matptr + ZERO ; 
  ...
  mat100 = *( (Float *) ( (MAT_IMM100) + (matptr) ) ) ; 
  mat101 = *( (Float *) ( (MAT_IMM101) + (matptr) ) ) ; 
  mat110 = *( (Float *) ( (MAT_IMM110) + (matptr) ) ) ; 
  mat111 = *( (Float *) ( (MAT_IMM111) + (matptr) ) ) ; 
  mat120 = *( (Float *) ( (MAT_IMM120) + (matptr) ) ) ; 
  mat121 = *( (Float *) ( (MAT_IMM121) + (matptr) ) ) ; 
  mat000 = vec200 * vec100 + mat000 ;
  mat001 = vec200 * vec101 + mat001 ;
  mat000 = vec201 * vec101 + mat000 ;
  mat001 = - ( vec201 * vec100 - mat001 );
  *( (Float *) ( (MAT_IMM000) + (outptr) ) ) = mat000; 
  *( (Float *) ( (MAT_IMM001) + (outptr) ) ) = mat001; 
  mat010 = vec210 * vec100 + mat010 ;
  mat011 = vec210 * vec101 + mat011 ;
  mat010 = vec211 * vec101 + mat010 ;
  mat011 = - ( vec211 * vec100 - mat011 );
  *( (Float *) ( (MAT_IMM010) + (outptr) ) ) = mat010; 
  *( (Float *) ( (MAT_IMM011) + (outptr) ) ) = mat011; 
  mat020 = vec220 * vec100 + mat020 ;
  mat021 = vec220 * vec101 + mat021 ;
  ...
  if ( predicate >= 0 ) goto cross_look_s_lab2;
...
/*preload PRER1 src1_idx */
  ...
  *( (Float *) ( (MAT_IMM021) + (outptr) ) ) = mat021; 
  ...
  mat200 = *( (Float *) ( (MAT_IMM200) + (outptr) ) ) ; 
  mat201 = *( (Float *) ( (MAT_IMM201) + (outptr) ) ) ; 
  mat210 = *( (Float *) ( (MAT_IMM210) + (outptr) ) ) ; 
  mat211 = *( (Float *) ( (MAT_IMM211) + (outptr) ) ) ; 
  mat220 = *( (Float *) ( (MAT_IMM220) + (outptr) ) ) ; 
  mat221 = *( (Float *) ( (MAT_IMM221) + (outptr) ) ) ; 
  vec120 = A * vec120  ;
  vec121 = A * vec121  ;
  mat100 = vec200 * vec110 + mat100 ;
  mat101 = vec200 * vec111 + mat101 ;
  mat100 = vec201 * vec111 + mat100 ;
  mat101 = - ( vec201 * vec110 - mat101 );
  src2_idx =   ( Isize ) + ( src2_idx )  ;
  prefscratch = * ( (unsigned long *) ( (PRE0)+(src2_idx) ) )  ;
  prefscratch = prefscratch * VEC_ATOM ; 
  vec2ptr = LOOKUP1 + prefscratch ; 
  prefscratch = * ( (unsigned long *) ( (SHFT_PREF_IMM)+(src2_idx) ) )  ;
  prefscratch = prefscratch * VEC_ATOM ; 
  prefscratch = LOOKUP1 + prefscratch ; 
  if ( predicate >= 0 ) goto cross_look_s_lab3;
  prefscratch = StackPointer | StackPointer ; 
cross_look_s_lab3:
/*preload PRER0 prefscratch */
/*preload PRER1 src2_idx */
  ...
  *( (Float *) ( (MAT_IMM101) + (outptr) ) ) = mat101; 
  ...
  prefscratch = prefscratch * MAT_ATOM ; 
  prefscratch = LOOKUP2 + prefscratch ; 
  if ( predicate >= 0 ) goto cross_look_s_lab4;
  prefscratch = StackPointer | StackPointer ; 
cross_look_s_lab4:
/*preload PRER0 prefscratch */
...
/*preload PRER1 dest_idx */
  ...
  *( (Float *) ( (MAT_IMM221) + (outptr) ) ) = mat221; 
  ...
  if ( counter >  0 ) goto cross_look_s_lab1;
cross_look_s_lab0:
