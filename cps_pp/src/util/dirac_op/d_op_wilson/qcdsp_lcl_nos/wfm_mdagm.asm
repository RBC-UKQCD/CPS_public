...
**  $Header: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_wilson/qcdsp_lcl_nos/wfm_mdagm.asm,v 1.2 2004-01-13 20:39:43 chulwoo Exp $
**  $Id: wfm_mdagm.asm,v 1.2 2004-01-13 20:39:43 chulwoo Exp $
**  $Name: not supported by cvs2svn $
**  $Locker:  $
**  $Log: not supported by cvs2svn $
**  Revision 1.1.1.1.10.1  2003/11/06 20:23:03  cwj
**  *** empty log message ***
**
...
**
**  $RCSfile: wfm_mdagm.asm,v $
**  $Revision: 1.2 $
**  $Source: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_wilson/qcdsp_lcl_nos/wfm_mdagm.asm,v $
**  $State: Exp $
**
**--------------------------------------------------------------------
****************************************************************************************
*---------------------------------------------------------------------------------------
* _wfm_mdagm
* It computes computes chi = M^dag.M * psii  for Wilson fermions.
*
*>>>>      float wfm_mdagm(float *chi, float *u_eo[2], 
*>>>> 		           float *psi, float *mp_sq, float *phi,
