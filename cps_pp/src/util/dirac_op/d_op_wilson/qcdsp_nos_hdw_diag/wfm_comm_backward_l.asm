...
**  $Header: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_wilson/qcdsp_nos_hdw_diag/wfm_comm_backward_l.asm,v 1.2 2004-01-13 20:39:46 chulwoo Exp $
**  $Id: wfm_comm_backward_l.asm,v 1.2 2004-01-13 20:39:46 chulwoo Exp $
...
**
**  $RCSfile: wfm_comm_backward_l.asm,v $
**  $Revision: 1.2 $
**  $Source: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_wilson/qcdsp_nos_hdw_diag/wfm_comm_backward_l.asm,v $
**  $State: Exp $
**
**--------------------------------------------------------------------
	.version 30
