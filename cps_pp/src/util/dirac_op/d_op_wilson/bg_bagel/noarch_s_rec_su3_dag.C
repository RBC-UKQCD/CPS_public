...
extern "C" {
#endif
 void s_rec_su3_dag (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3)
{
  ...
  if ( length <= 0 ) goto s_rec_su3_dag_lab0;
CONSTR0=CONST0;
CONSTR1=CONST1;
CONSTR2=CONST2;
CONSTR3=CONST3;
...
/*preload CONSTR4 Ufetch */
  ...
  *( (float *) ( (CHI_IMM101) + (Chiout) ) ) = PSI221; 
  ...
  Btmp011 = *( (float *) ( (CHI_IMM111) + (Chiin) ) ) ; 
  mu =   ( minus1 ) + ( mu )  ;
  if ( mu >  0 ) goto s_rec_su3_dag_lab2;
s_rec_su3_dag_lab3:
/*pragma_store_lim 2*/
/*pragma_dcbt_space 5*/
/*pragma_dcbt_post 1*/
...
/*preload CONSTR1 Chiin */
  ...
  if ( length >  0 ) goto s_rec_su3_dag_lab1;
  *( (float *) ( (CHI_IMM110) + (Chidrain) ) ) = PSI030; 
  *( (float *) ( (CHI_IMM111) + (Chidrain) ) ) = PSI031; 
  *( (float *) ( (CHI_IMM200) + (Chidrain) ) ) = PSI130; 
  *( (float *) ( (CHI_IMM201) + (Chidrain) ) ) = PSI131; 
