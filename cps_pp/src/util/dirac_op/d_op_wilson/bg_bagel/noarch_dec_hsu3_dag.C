...
extern "C" {
#endif
 void dec_hsu3_dag (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3)
{
...
CONSTR4=CONST4;
  ...
  if ( length <= 0 ) goto dec_hsu3_dag_lab0;
...
/*pragma_dcbt_space 8*/
  ...
  Chiminus = mem + hstk0 ; 
  Chiplus = Chiout + ZERO_IMM ; 
  tab =   ( Isize ) + ( tab )  ;
  Chiout = * ( (unsigned long *) ( (zeromulti)+(tab) ) )  ;
  Chitmp1 = mem + hstk1 ; 
  Chitmp2 = Chiout + ZERO_IMM ; 
  tab =   ( Isize ) + ( tab )  ;
  Chiout = * ( (unsigned long *) ( (zeromulti)+(tab) ) )  ;
  C0 = U00 + X01 ; 
...
/*preload CONSTR1 pref */
  ...
  V01 = *( (Float *) ( (CHIIMM111) + (Chiin) ) ) ; 
  mu =   ( minus1 ) + ( mu )  ;
  if ( mu >  0 ) goto dec_hsu3_dag_lab2;
dec_hsu3_dag_lab3:
/*pragma_dcbt_space 4*/
/*pragma_dcbt_post 1*/
  *( (Float *) ( (CHIIMM110) + (Chitmp1) ) ) = F0; 
...
/*pragma_load_lim 10*/
  ...
  *( (Float *) ( (CHIIMM211) + (Chitmp1) ) ) = D1; 
  ...
  if ( length >  0 ) goto dec_hsu3_dag_lab1;
dec_hsu3_dag_lab0:
