...
extern "C" {
#endif
 void dec_hsu3 (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3)
{
...
CONSTR4=CONST4;
  ...
  if ( length <= 0 ) goto dec_hsu3_lab0;
...
/*pragma_load_lim 10*/
  ...
  *( (Float *) ( (CHIIMM211) + (Chitmp1) ) ) = D1; 
  ...
  if ( length >  0 ) goto dec_hsu3_lab1;
dec_hsu3_lab0:
