...
#define CHI_IMM000 0 
#define CHI_IMM001 8 
#define CHI_IMM010 16 
#define CHI_IMM011 24 
#define CHI_IMM100 32 
#define CHI_IMM101 40 
#define CHI_IMM110 48 
#define CHI_IMM111 56 
#define CHI_IMM200 64 
#define CHI_IMM201 72 
#define CHI_IMM210 80 
#define CHI_IMM211 88 
#define GIMM000 0 
#define GIMM001 8 
#define GIMM010 16 
#define GIMM011 24 
...
extern "C" {
#endif
 void rec_su3_dag (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3)
{
  ...
  if ( length <= 0 ) goto rec_su3_dag_lab0;
CONSTR0=CONST0;
CONSTR1=CONST1;
CONSTR2=CONST2;
CONSTR3=CONST3;
...
/*pragma_load_lim 1*/
  ...
  PSI020 = Atmp011 - Btmp011 ; 
  PSI021 = Btmp010 - Atmp010 ; 
  PSI030 = Atmp001 - Btmp001 ; 
  PSI031 = Btmp000 - Atmp000 ; 
...
/*pragma_load_lim 1*/
  ...
  PSI120 = Atmp011 - Btmp011 ; 
  PSI121 = Btmp010 - Atmp010 ; 
  PSI130 = Atmp001 - Btmp001 ; 
  PSI131 = Btmp000 - Atmp000 ; 
...
/*preload CONSTR4 Ufetch */
  ...
  PSI220 = Atmp011 - Btmp011 ; 
  PSI221 = Btmp010 - Atmp010 ; 
  PSI230 = Atmp001 - Btmp001 ; 
  PSI231 = Btmp000 - Atmp000 ; 
...
/*preload CONSTR2 Chiin */
  ...
  if ( length >  0 ) goto rec_su3_dag_lab1;
  *( (Float *) ( (CHI_IMM110) + (Chidrain) ) ) = PSI030; 
  *( (Float *) ( (CHI_IMM111) + (Chidrain) ) ) = PSI031; 
  *( (Float *) ( (CHI_IMM200) + (Chidrain) ) ) = PSI130; 
  *( (Float *) ( (CHI_IMM201) + (Chidrain) ) ) = PSI131; 
