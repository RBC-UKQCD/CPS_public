...
extern "C" {
#endif
 void s_dec_hsu3_dag (unsigned long Arg0,unsigned long Arg1,unsigned long Arg2,unsigned long Arg3)
{
...
CONSTR4=CONST4;
  ...
  if ( length <= 0 ) goto s_dec_hsu3_dag_lab0;
...
/*preload CONSTR1 pref */
  ...
  V01 = *( (float *) ( (CHIIMM111) + (Chiin) ) ) ; 
  mu =   ( minus1 ) + ( mu )  ;
  if ( mu >  0 ) goto s_dec_hsu3_dag_lab2;
s_dec_hsu3_dag_lab3:
/*pragma_dcbt_space 4*/
/*pragma_dcbt_post 1*/
  *( (float *) ( (CHIIMM110) + (Chitmp1) ) ) = F0; 
...
/*pragma_load_lim 10*/
  ...
  *( (float *) ( (CHIIMM211) + (Chitmp1) ) ) = D1; 
  ...
  if ( length >  0 ) goto s_dec_hsu3_dag_lab1;
s_dec_hsu3_dag_lab0:
