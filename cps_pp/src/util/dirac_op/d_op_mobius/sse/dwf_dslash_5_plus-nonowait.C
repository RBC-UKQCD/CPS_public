...
//  CVS keywords
//
//  $Source: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_mobius/sse/dwf_dslash_5_plus-nonowait.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
//------------------------------------------------------------------
...
{
  if (dag == 0) 
    dwf_dslash_5_plus_dag0(out, in, mass, dwf_lib_arg, a_five_inv);
  else
    dwf_dslash_5_plus_dag1(out, in, mass, dwf_lib_arg, a_five_inv);
}
...
{
  if (dag == 0) 
    dwf_dslash_5_plus_dag0(out, in, mass, dwf_lib_arg, GJP.DwfA5Inv());
  else
    dwf_dslash_5_plus_dag1(out, in, mass, dwf_lib_arg, GJP.DwfA5Inv());
}
