...
//  CVS keywords
//
//  $Source: /home/chulwoo/CPS/repo/CVS/cps_only/cps_pp/src/util/dirac_op/d_op_mobius/sse/dwf_end_sse.C,v $
//  $State: Exp $
//
//--------------------------------------------------------------------
//------------------------------------------------------------------
...
void dwf_end( Dwf *dwf_p)
{
  ...
  //----------------------------------------------------------------
#if 0
  VRB.Sfree(cname,fname, "frm_tmp3", dwf_p->frm_tmp3);
  sfree(dwf_p->frm_tmp3);
#endif
